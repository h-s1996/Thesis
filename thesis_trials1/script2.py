...
for p in p_eig:
    ...
    for i in range(len(train_set)):
        ...
        test_score.append(naive.test_score(test_set[i].get_lsa_results(), test_set[i].get_class_labels(), "test"))
        naive.test_score(train_set[i].get_lsa_results(), train_set[i].get_class_labels(), "train")
